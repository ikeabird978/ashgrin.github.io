...
function initCanvasAnimation() {
    ...
    // ====================== 【颜色组（可无限增加）】 ======================
    const colorGroups = [
    // 组 2：至上主义核心三色（1913-1918）- 最经典
    [
        'rgba(26, 26, 26, 1)',      // 绝对黑（原作实际色，非纯黑）
        'rgba(248, 246, 242, 1)',   // 无限白（原作实际色，非纯白）
        'rgba(212, 43, 43, 1)',     // 马列维奇红
    ],
    // 组 3：至上主义基础原色（1916-1917）- 彩色时期
    [
        'rgba(26, 26, 26, 1)',      // 绝对黑
        'rgba(248, 246, 242, 1)',   // 无限白
        'rgba(212, 43, 43, 1)',     // 马列维奇红
        'rgba(242, 196, 29, 1)',    // 至上黄
        'rgba(36, 86, 164, 1)',     // 构成蓝
        'rgba(27, 107, 58, 1)',     // 至上绿（罕见）
        'rgba(26, 26, 26, 1)',
        'rgba(248, 246, 242, 1)'
    ],
    // 组 4：至上主义中性色（平衡层次）
    [
        ...
        'rgba(176, 176, 176, 1)',   // 浅灰
        'rgba(232, 229, 224, 1)',   // 暖灰
        'rgba(74, 74, 74, 1)',
        'rgba(232, 229, 224, 1)'
    ],
    // 组 5：至上主义晚期暖调（1920年代后）- ✅ 最适合你的博客风格
    [
        'rgba(140, 109, 92, 1)',    // 赭石棕（你的博客主题色）
        'rgba(212, 197, 184, 1)',   // 土黄（你的博客线条色）
        'rgba(74, 69, 64, 1)',      // 深褐（你的博客次要文字色）
        'rgba(249, 245, 240, 1)',   // 米白（你的博客背景色）
        'rgba(200, 147, 60, 1)',    // 标准赭石
        'rgba(122, 92, 69, 1)',     // 深棕
        'rgba(239, 230, 221, 1)',   // 浅米（你的博客侧边栏色）
        'rgba(191, 169, 152, 1)'    // 浅棕
    ]
    ];
